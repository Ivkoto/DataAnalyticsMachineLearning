...
sns.scatterplot(data=df, x='body_mass_g', y='bill_length_mm', alpha=0.7, hue='species', size='gender') - alpha is for opacity, size is for the size of the dot
move the legend outside of the figure itself - plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1));
